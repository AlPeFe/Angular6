...
extend(ChartTracker.prototype, baseTrackerPrototype, {
    ...
    _prepare: function() {
        ...
        wheelZoomingEnabled && root.on(addNamespace(wheelEvent.name, EVENT_NS), function(e) {
            var isOriginalScale, rootOffset = that._renderer.getRootOffset(),
        ...
        root.on(addNamespace("dxc-scroll-start", EVENT_NS), function(e) {
            ...
            if (that._gestureChange(that._getGestureParams(e, {
                    left: 0,
                    top: 0
                }))) {
    ...
    _handleStartScrollTimeout: function(e) {
        var that = this;
        if (that._gestureStartTimeStamp && 1 === that._startGesture.touches && e.timeStamp - that._gestureStartTimeStamp < TOUCHSTART_TIMEOUT) {
            that._stopEvent(e);
            that._pointerOut();
