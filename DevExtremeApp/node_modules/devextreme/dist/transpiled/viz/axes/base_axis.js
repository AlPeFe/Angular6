...
Axis.prototype = {
    ...
    _calculateRangeInterval: function _calculateRangeInterval(dataLength, interval) {
        var isDateTime = this._options.dataType === "datetime",
            minArgs = [],
            addToArgs = function addToArgs(value) {
    ...
    _applyMargins: function _applyMargins(range) {
        var that = this,
            ...
            marginValue = 0,
            type = options.type,
            valueMarginsEnabled = options.valueMarginsEnabled && type !== _axes_constants2.default.discrete && type !== "semidiscrete",
        ...
        function addMargin(value, margin, marginOption) {
            if (!(0, _type.isDefined)(marginOption) && !(margins.percentStick && _abs(value) === 1 && !isArgumentAxis)) {
    ...
    // DEPRECATED IN 15_2
    correctTicksOnDeprecated: function correctTicksOnDeprecated() {
    ...
    zoom: function zoom(min, max, skipAdjusting) {
        var that = this,
            options = that._options,
            minOpt = options.min,
            maxOpt = options.max,
    ...
    getRangeData: function getRangeData(useZoom) {
        var that = this;
