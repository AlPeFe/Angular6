...
var dxBarGauge = dxBaseGauge.inherit({
    ...
    _arrangeBars: function _arrangeBars(count) {
        var that = this,
    ...
    _setBarsCount: function _setBarsCount(count) {
        var that = this,
            i,
            ii;
    ...
    _updateBars: function _updateBars(values) {
        var that = this,
            i,
            ii;
    ...
    _animateBars: function _animateBars(values) {
        var that = this,
            i,
...
_extend(BarWrapper.prototype, {
    ...
    beginAnimation: function beginAnimation(value) {
        var that = this,
