...
var dxChart = AdvancedChart.inherit({
    ...
    _isZooming: function _isZooming() {
        ...
        var viewportDistance = businessRange.axisType === "discrete" ? vizUtils.getCategoriesInfo(businessRange.categories, min, max).categories.length : Math.abs(max - min);
    ...
    _transformArgument: function _transformArgument(translate, scale) {
        var that = this,
            rotated = that._isRotated(),
            settings,
            clipSettings,
