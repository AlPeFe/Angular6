...
function Tooltip(params) {
    ...
    that._wrapper = $("<div>").css({ position: "absolute", overflow: "visible", height: "1px", "pointerEvents": "none" }) // T265557, T447623
...
Tooltip.prototype = {
    ...
    show: function show(formatObject, params, eventData) {
        var that = this,
            state = {},
    ...
    move: function move(x, y, offset) {
        ...
        if (that._calculatePosition(x, y, offset, canvas)) {
            ...
            that._renderer.resize(coords.hp === "out" ? canvas.fullWidth + contentSize.lm : contentSize.fullWidth, coords.vp === "out" ? canvas.fullHeight : contentSize.fullHeight);
        }
    ...
    _calculatePosition: function _calculatePosition(x, y, offset, canvas) {
        var that = this,
            options = that._options,
