...
SvgElement.prototype = {
    ...
    getBBox: function getBBox() {
        ...
        if (transformation.rotate) {
            bBox = _rotateBBox(bBox, [("rotateX" in transformation ? transformation.rotateX : transformation.x) || 0, ("rotateY" in transformation ? transformation.rotateY : transformation.y) || 0], -transformation.rotate); // Angle is transformed from svg to right-handed cartesian space
        } else {
...
Renderer.prototype = {
    ...
    text: function text(_text, x, y) {
        ...
        return elem.attr({ text: _text, x: x || 0, y: y || 0 });
    },
    ...
    pattern: function pattern(color, hatching, _id) {
        ...
        d = _normalizeEnum(hatching.direction) === "right" ? "M " + stepTo2 + " " + -stepTo2 + " L " + -stepTo2 + " " + stepTo2 + " M 0 " + step + " L " + step + " 0 M " + stepBy15 + " " + stepTo2 + " L " + stepTo2 + " " + stepBy15 : "M 0 0 L " + step + " " + step + " M " + -stepTo2 + " " + stepTo2 + " L " + stepTo2 + " " + stepBy15 + " M " + stepTo2 + " " + -stepTo2 + " L " + stepBy15 + " " + stepTo2;
    ...
    getGrayScaleFilter: function getGrayScaleFilter() {
        ...
        that._createElement("feColorMatrix").attr({ type: "matrix", values: "0.3333 0.3333 0.3333 0 0 0.3333 0.3333 0.3333 0 0 0.3333 0.3333 0.3333 0 0 0 0 0 0.6 0" }).append(filter);
