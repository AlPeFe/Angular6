...
var dxSparkline = BaseSparkline.inherit({
    ...
    _parseWinlossDataSource: function _parseWinlossDataSource(data, argField, valField) {
        var lowBarValue = -1,
            zeroBarValue = 0,
            highBarValue = 1,
            delta = 0.0001,
    ...
    _createLineCustomizeFunction: function _createLineCustomizeFunction(pointIndexes) {
        var that = this,
            options = that._allOptions;
    ...
    _findMinMax: function _findMinMax(data) {
        var that = this,
