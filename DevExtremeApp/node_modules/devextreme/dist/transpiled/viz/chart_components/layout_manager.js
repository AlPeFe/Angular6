...
LayoutManager.prototype = {
    ...
    _processAdaptiveLayout: function _processAdaptiveLayout(panes, rotated, canvas, funcAxisDrawer) {
        ...
        items.slice().reverse().forEach(function (item) {
            ...
            needRedraw = layoutOptions.cutSide === "vertical" && size.width < 0 || layoutOptions.cutSide === "horizontal" && size.height < 0 || layoutOptions.cutSide === "vertical" && size.height > 0 || layoutOptions.cutSide === "horizontal" && size.width > 0;
