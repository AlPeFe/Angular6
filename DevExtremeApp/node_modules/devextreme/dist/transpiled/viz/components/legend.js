...
extend(legendPrototype, {
    ...
    _createHint: function _createHint(data, label) {
        var labelFormatObject = this._getCustomizeObject(data),
    ...
    _createBackground: function _createBackground() {
        ...
        if (that._options.border.visible || (isInside || color) && color !== NONE) {
            that._background = that._renderer.rect(0, 0, 0, 0).attr({ fill: fill, "class": that._backgroundClass }).append(that._insideLegendGroup);
        }
    },
...
exports.plugin = {
    ...
    init: function init() {
        ...
        that._legend = new exports.Legend({
            ...
            group: group,
            textField: "text",
            getFormatObject: function getFormatObject(item) {
                return {
                    item: item,
                    text: item.argument
                };
