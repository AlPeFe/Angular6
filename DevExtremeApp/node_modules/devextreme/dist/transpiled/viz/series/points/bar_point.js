...
module.exports = _extend({}, symbolPoint, {
    ...
    _drawMarker: function _drawMarker(renderer, group, animationEnabled) {
        ...
        that.graphic = renderer.rect(x, y, width, height).attr({ rx: r, ry: r }).smartAttr(style).data({ "chart-data-point": that }).append(group);
    },
    ...
    _getEdgeTooltipParams: function _getEdgeTooltipParams(x, y, width, height) {
