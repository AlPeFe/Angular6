...
module.exports = _extend({}, symbolPoint, {
    ...
    setLabelEllipsis: function setLabelEllipsis() {
        var that = this,
            label = that._label,
    ...
    _drawMarker: function _drawMarker(renderer, group, animationEnabled, firstDrawing) {
        ...
        that.graphic = renderer.arc(that.centerX, that.centerY, radiusInner, radiusOuter, toAngle, fromAngle).attr({ "stroke-linejoin": "round" }).smartAttr(that._getStyle()).data({ "chart-data-point": that }).sharp().append(group);
    },
    ...
    _getMarkerVisibility: function _getMarkerVisibility() {
        return true;
    },
