...
exports.stock = _extend({}, scatterSeries, {
    ...
    _checkData: function _checkData(data) {
        return _isDefined(data.argument) && data.highValue !== undefined && data.lowValue !== undefined && data.openValue !== undefined && data.closeValue !== undefined && data.highValue === data.highValue && data.lowValue === data.lowValue;
    },
