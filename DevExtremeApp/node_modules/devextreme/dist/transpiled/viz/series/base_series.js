...
var seriesNS = {},
    ...
    getEmptyBusinessRange = function getEmptyBusinessRange() {
    return { arg: {}, val: {} };
};
...
Series.prototype = {
    ...
    _drawElements: function _drawElements(animationEnabled, firstDrawing, translateAllPoints) {
        ...
        segments = points.reduce(function (segments, p) {
            ...
            if (p.hasValue() && pointHasCoords) {
                translateAllPoints && that._drawPoint({ point: p, groups: groupForPoint, hasAnimation: animationEnabled, firstDrawing: firstDrawing });
                segment.push(p);
            } else {
    ...
    _getAggregationMethod: function _getAggregationMethod(isDiscrete) {
    ...
    _resample: function _resample(_ref2, data) {
        ...
        var that = this,
            ...
            addAggregatedData = function addAggregatedData(target, data, aggregationInfo) {
            if (!data) {
                return;
            }
