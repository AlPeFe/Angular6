...
function checkGestureEventsForScaleEdges(scrollThreshold, scale, scroll, touches, zoomArgs) {
    ...
    return touches === 2 && scale === 1 || (zoomArgs || isDiscreteAxis || !this.isEqualRange({ min: businessRange.minVisible, max: businessRange.maxVisible })) && !scrollBarNearMin && !scrollBarNearMax || !isOriginalScale && (scalingEventAtMin || scalingEventAtMax) || isOriginalScale && scale > 1;
}
...
_Translator2d.prototype = {
    ...
    isEmptyValueRange: function isEmptyValueRange() {
