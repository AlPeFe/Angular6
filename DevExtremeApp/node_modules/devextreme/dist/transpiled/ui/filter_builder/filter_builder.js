...
var FilterBuilder = Widget.inherit({
    ...
    */
    ...
    _createGroupElement: function _createGroupElement(criteria, parent) {
        var that = this,
        ...
        options.popup = {
            onShown: function onShown(info) {
                ...
                eventsEngine.on(treeViewElement, "keyup keydown", function (e) {
                    if (e.type === "keydown" && e.keyCode === TAB_KEY || e.type === "keyup" && (e.keyCode === ESCAPE_KEY || e.keyCode === ENTER_KEY)) {
                        info.component.hide();
    ...
    _getGroupOperations: function _getGroupOperations() {
        var result = [],
            operatorDescription,
    ...
    _createAddButton: function _createAddButton(addGroupHandler, addConditionHandler) {
    ...
    _createValueEditorWithEvents: function _createValueEditorWithEvents(item, field, $container) {
        var document = domAdapter.getDocument(),
            ...
            isFocusOnEditorParts = function isFocusOnEditorParts(target) {
