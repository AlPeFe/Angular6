...
var Form = Widget.inherit({
    ...
    _isExpectedItem: function _isExpectedItem(item, fieldName) {
        return item && (item.dataField === fieldName || item.name === fieldName || this._getTextWithoutSpaces(item.title) === fieldName || item.itemType === "group" && this._getTextWithoutSpaces(item.caption) === fieldName);
    },
