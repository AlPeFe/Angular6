...
var LayoutManager = Widget.inherit({
    ...
    _processItem: function _processItem(item) {
        ...
        if ((typeof item === "undefined" ? "undefined" : _typeof(item)) === "object" && !item.itemType) {
    ...
    _clearEditorInstances: function _clearEditorInstances() {
    ...
    _addWrapperInvalidClass: function _addWrapperInvalidClass(editorInstance) {
        var wrapperClass = "." + FIELD_ITEM_CONTENT_WRAPPER_CLASS,
            ...
            $(e.element).parents(wrapperClass).toggleClass(INVALID_CLASS, e.event.type === "focusin" && e.component.option("isValid") === false);
        };
    ...
    _registerEditorInstance: function _registerEditorInstance(instance, options) {
    ...
    linkEditorToDataField: function linkEditorToDataField(editorInstance, dataField, editorType) {
        ...
        editorInstance.on("valueChanged", function (args) {
            var isObjectValue = _typeof(args.value) === "object",
