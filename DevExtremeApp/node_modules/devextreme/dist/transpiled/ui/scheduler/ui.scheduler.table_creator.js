...
var SchedulerTableCreator = {
    ...
    makeGroupedTable: function makeGroupedTable(type, groups, cssClasses, cellCount, cellTemplate) {
        var rows = [];
    ...
    _makeHorizontalGroupedRows: function _makeHorizontalGroupedRows(groups, cssClasses, cellCount, cellTemplate) {
        var repeatCount = 1,
    ...
    _makeGroupedRowCells: function _makeGroupedRowCells(group, repeatCount, cssClasses, cellTemplate) {
        var cells = [],
            items = group.items,
