...
var Scheduler = Widget.inherit({
    ...
    _getDayDuration: function _getDayDuration() {
    ...
    _createAppointmentForm: function _createAppointmentForm(appointmentData, $content, processTimeZone) {
    ...
    _getPopupToolbarItems: function _getPopupToolbarItems() {
        return [{ shortcut: "done", location: "after", onClick: this._doneButtonClickHandler.bind(this) }, { shortcut: "cancel", location: "after" }];
    },
    ...
    _getRecurrenceExceptionDate: function _getRecurrenceExceptionDate(exceptionDate, targetStartDate) {
    ...
    _showRecurrenceChangeConfirm: function _showRecurrenceChangeConfirm(isDeleted) {
        ...
        return dialog.custom({
            ...
            showTitle: true,
            buttons: [{ text: seriesText, onClick: function onClick() {
                    return true;
                } }, { text: occurrenceText, onClick: function onClick() {
                    return false;
                } }]
        }).show();
    },
    ...
    _getCoordinates: function _getCoordinates(dates, appointmentResources, allDay) {
        var result = [];
    ...
    _getEndDate: function _getEndDate(appointment) {
        var endDate = this.fire("getField", "endDate", appointment);
