...
var AppointmentLayoutManager = Class.inherit({
    ctor: function ctor(instance, renderingStrategy) {
        this.instance = instance;

        renderingStrategy && this.initRenderingStrategy(renderingStrategy);
    },

    getCellDimensions: function getCellDimensions(options) {
    ...
    getGroupOrientation: function getGroupOrientation(options) {
        if (this.instance._workSpace) {
            options.callback(this.instance._workSpace._getRealGroupOrientation());
        }
    },

    initRenderingStrategy: function initRenderingStrategy(renderingStrategy) {
        var Strategy = RENDERING_STRATEGIES[renderingStrategy];
        this._renderingStrategyInstance = new Strategy(this.instance);
        this.renderingStrategy = renderingStrategy;
    },

    createAppointmentsMap: function createAppointmentsMap(items) {
        var result = [];
    ...
    _markDeletedAppointments: function _markDeletedAppointments(renderedItems, appointments) {
        var itemFound,
            result = [];
    ...
    markRepaintedAppointments: function markRepaintedAppointments(appointments, renderedItems) {
    ...
    _compareSettings: function _compareSettings(currentItem, item, isAgenda) {
