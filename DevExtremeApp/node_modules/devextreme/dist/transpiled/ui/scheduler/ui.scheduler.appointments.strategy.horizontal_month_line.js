...
var HorizontalMonthLineRenderingStrategy = HorizontalAppointmentsStrategy.inherit({
    ...
    getDeltaTime: function getDeltaTime(args, initialSize) {
    ...
    createTaskPositionMap: function createTaskPositionMap(items, skipSorting) {
        if (!skipSorting) {
    ...
    _getSortedPositions: function _getSortedPositions(map, skipSorting) {
