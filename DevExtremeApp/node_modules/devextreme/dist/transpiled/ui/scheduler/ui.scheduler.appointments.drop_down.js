...
var dropDownAppointments = Class.inherit({
    render: function render(options, instance) {
    ...
    repaintExisting: function repaintExisting($container) {
    ...
    _paintMenuButton: function _paintMenuButton($menu, color, itemsColors) {
    ...
    _createButtonTemplate: function _createButtonTemplate(appointmentCount) {
    ...
    _applyInnerShadow: function _applyInnerShadow($element) {
        $element.css("boxShadow", "inset " + $element.get(0).getBoundingClientRect().width + "px 0 0 0 rgba(0, 0, 0, 0.3)");
    },

    _createAppointmentClickAction: function _createAppointmentClickAction() {
    ...
    _createDropDownMenu: function _createDropDownMenu(config) {
    ...
    _dragHandler: function _dragHandler(e, allDay) {
        var coordinates = {
    ...
    _getRecurrencePart: function _getRecurrencePart(appointments, startDate) {
        var result;
    ...
    _initDynamicTemplate: function _initDynamicTemplate(items) {
        var that = this;
    ...
    _createDropDownAppointmentTemplate: function _createDropDownAppointmentTemplate(appointmentData, appointmentElement, color) {
        var dateString = "",
            appointmentMarkup = [],
            borderSide = "left",
            $title,
    ...
    _createButtons: function _createButtons(appointmentData) {
