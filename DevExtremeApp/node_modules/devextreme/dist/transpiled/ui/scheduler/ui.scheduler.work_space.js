...
var SchedulerWorkSpace = Widget.inherit({
    ...
    _setFocusedCell: function _setFocusedCell($cell, isMultiSelection) {
        ...
        this._selectionChangedAction({ selectedCellData: selectedCellData });
    },
    ...
    _getGroupHeaderClass: function _getGroupHeaderClass() {
    ...
    _createHeaderScrollable: function _createHeaderScrollable() {
        var dateTableScrollableOnScroll,
            $headerScrollable = $("<div>").addClass(SCHEDULER_HEADER_SCROLLABLE_CLASS).appendTo(this.$element());
    ...
    _makeGroupRows: function _makeGroupRows(groups) {
    ...
    _getDayDurationInMs: function _getDayDurationInMs() {
    ...
    _getCells: function _getCells(allDay) {
