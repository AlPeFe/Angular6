...
var AgendaRenderingStrategy = BaseAppointmentsStrategy.inherit({
    ...
    getAppointmentGeometry: function getAppointmentGeometry(geometry) {
        return geometry;
    },

    createTaskPositionMap: function createTaskPositionMap(appointments) {
    ...
    _calculateGroupIndex: function _calculateGroupIndex(apptIndex, appointmentsByResources) {
        var resultInd,
            counter = 0;
