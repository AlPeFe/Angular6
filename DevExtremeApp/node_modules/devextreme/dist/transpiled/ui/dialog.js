    ...
    _defaultOptionsRules: function _defaultOptionsRules() {
        return this.callBase().concat([{
            ...
            device: function device(_device2) {
                var currentTheme = (themes.current() || "").split(".")[0];
                return _device2.phone && currentTheme === "win8";
            },
            options: {
                position: {
                    my: "top center",
...
exports.confirm = function (message, title, showTitle) {
    var options = isPlainObject(message) ? message : {
        ...
        message: message,
        showTitle: showTitle,
        buttons: [{ text: messageLocalization.format("Yes"), onClick: function onClick() {
                return true;
            } }, { text: messageLocalization.format("No"), onClick: function onClick() {
                return false;
            } }]
    };
