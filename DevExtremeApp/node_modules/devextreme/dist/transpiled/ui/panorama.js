...
var moveBackground = function moveBackground($element, position) {
...
var animation = {
    ...
    backgroundMove: function backgroundMove($element, position, completeAction) {
    ...
    titleMove: function titleMove($title, position, completeAction) {
    ...
    itemMove: function itemMove($item, itemPosition, completeAction) {
...
var endAnimation = function endAnimation(elements) {
    if (!elements) {
        return;
    }
...
var PanoramaItemsRenderStrategy = Class.inherit({
    ...
    allItemElements: function allItemElements() {
    ...
    _itemMargin: function _itemMargin() {
        return this._containerWidth() * PANORAMA_ITEM_MARGIN_SCALE;
    },

    _containerWidth: function _containerWidth() {
    ...
    _startNextPosition: function _startNextPosition() {
    ...
    _startPrevPosition: function _startPrevPosition() {
        if (this._isRTLEnabled()) {
...
var PanoramaTwoItemsRenderStrategy = PanoramaItemsRenderStrategy.inherit({
    ...
    _updateGhostItemContent: function _updateGhostItemContent(index) {
    ...
    _isGhostItemVisible: function _isGhostItemVisible() {
        return this._$ghostItem.css("opacity") === "1";
    },

    _swapGhostWithItem: function _swapGhostWithItem($item) {
        var $ghostItem = this._$ghostItem,
    ...
    updatePositions: function updatePositions(offset) {
    ...
    animateRollback: function animateRollback(currentIndex) {
        var that = this,
            ...
            isLastReplacedByGhost = currentIndex === 0 && offset > 0 && ghostOffset > 0 || currentIndex === 1 && ghostOffset < 0;
    ...
    detectBoundsTransition: function detectBoundsTransition(newIndex, currentIndex) {
    ...
    animateComplete: function animateComplete(boundCross, newIndex, currentIndex) {
        var that = this,
    ...
    _calculateItemPositions: function _calculateItemPositions(atIndex, ghostPosition) {
        var positions = [],
...
var PanoramaThreeAndMoreItemsRenderStrategy = PanoramaItemsRenderStrategy.inherit({
    ...
    animateRollback: function animateRollback(selectedIndex) {
        var $items = this._panorama._itemElements(),
    ...
    _calculateItemPositions: function _calculateItemPositions(atIndex, movingBack) {
...
var Panorama = CollectionWidget.inherit({
    ...
    _getDefaultOptions: function _getDefaultOptions() {
        return extend(this.callBase(), {
            ...
            */
            ...
            titleExpr: function titleExpr(data) {
    ...
    _titleWidth: function _titleWidth() {
    ...
    _clearTitleWidthCache: function _clearTitleWidthCache() {
    ...
    _initItemsRenderStrategy: function _initItemsRenderStrategy() {
    ...
    _initBackgroundImage: function _initBackgroundImage() {
    ...
    _toggleGhostTitle: function _toggleGhostTitle(visible) {
    ...
    _initItemsContainer: function _initItemsContainer() {
    ...
    _updatePositions: function _updatePositions(offset) {
        offset = offset || 0;
    ...
    _updateBackgroundPosition: function _updateBackgroundPosition(offset) {
        moveBackground(this.$element(), this._calculateBackgroundPosition(this.option("selectedIndex")) + offset);
    },

    _updateTitlePosition: function _updateTitlePosition(offset) {
        move(this._$title, this._calculateTitlePosition(this.option("selectedIndex")) + offset);
    },

    _animateRollback: function _animateRollback(currentIndex) {
    ...
    _animateBackgroundMove: function _animateBackgroundMove(toIndex) {
        return animation.backgroundMove(this.$element(), this._calculateBackgroundPosition(toIndex));
    },

    _animateTitleMove: function _animateTitleMove(toIndex) {
    ...
    _performBackgroundAnimation: function _performBackgroundAnimation(boundCross, newIndex) {
        if (boundCross) {
    ...
    _animateBackgroundBoundsTransition: function _animateBackgroundBoundsTransition(bound, newIndex) {
        var that = this,
            isLeft = bound === "left",
    ...
    _performTitleAnimation: function _performTitleAnimation(boundCross, newIndex) {
        if (boundCross) {
    ...
    _animateTitleBoundsTransition: function _animateTitleBoundsTransition(bound, newIndex) {
        var that = this,
    ...
    _swapGhostWithTitle: function _swapGhostWithTitle() {
        var $ghostTitle = this._$ghostTitle,
            $title = this._$title,
    ...
    _calculateTitlePosition: function _calculateTitlePosition(atIndex) {
    ...
    _calculateTitleStep: function _calculateTitleStep() {
        var panoramaWidth = this._elementWidth(),
            titleWidth = this._titleWidth(),
    ...
    _calculateBackgroundPosition: function _calculateBackgroundPosition(atIndex) {
        var panoramaWidth = this._elementWidth(),
    ...
    _calculateBackgroundStep: function _calculateBackgroundStep() {
    ...
    _calculateBackgroundScaledWidth: function _calculateBackgroundScaledWidth() {
