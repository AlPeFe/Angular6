...
var Submenu = ContextMenu.inherit({
    ...
    _renderDelimiter: function _renderDelimiter() {
    ...
    _overlayPositionedActionHandler: function _overlayPositionedActionHandler(arg) {
    ...
    _drawSubmenu: function _drawSubmenu($rootItem) {
