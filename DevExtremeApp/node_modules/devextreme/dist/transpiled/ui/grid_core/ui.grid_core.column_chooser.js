...
var ColumnChooserView = columnsView.ColumnsView.inherit({
    ...
    _updateList: function _updateList(allowUpdate) {
        var items,
    ...
    _initializePopupContainer: function _initializePopupContainer() {
        var that = this,
            ...
            dragEnabled: true,
            resizeEnabled: true,
            toolbarItems: [{ text: columnChooserOptions.title, toolbar: "top", location: isGenericTheme || isAndroid5Theme || isMaterial ? "before" : "center" }],
    ...
    _renderCore: function _renderCore(allowUpdate) {
