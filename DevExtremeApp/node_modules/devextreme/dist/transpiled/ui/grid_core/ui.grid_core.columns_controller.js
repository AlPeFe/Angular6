...
module.exports = {
    ...
    controllers: {
        columns: modules.Controller.inherit(function () {
            ...
            var getFixedPosition = function getFixedPosition(column) {
                return !column.fixedPosition ? "left" : column.fixedPosition;
            };

            var processExpandColumns = function processExpandColumns(columns, expandColumns, columnIndex) {
                ...
                if (rowspan > 1) {
                    expandColumnsByRow = iteratorUtils.map(expandColumnsByRow, function (expandColumn) {
                        return extend({}, expandColumn, { rowspan: rowspan });
                    });
                }
            ...
            var mergeColumns = function mergeColumns(columns, commandColumns, needToExtend) {
                var i,
                    column,
                    commandColumnIndex,
            ...
            return {
                ...
                getCommonSettings: function getCommonSettings() {
                ...
                updateFilter: function updateFilter(filter, remoteFiltering, columnIndex) {
                    var that = this;
                ...
                columnOption: function columnOption(identifier, option, value, notFireEvent) {
                    ...
                    for (i = 0; i < columns.length; i++) {
                        ...
                        } else if (columns[i].index === identifier || columns[i].name === identifier || columns[i].dataField === identifier || columns[i].caption === identifier) {
