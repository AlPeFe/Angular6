    ...
    controllers: {
        data: modules.Controller.inherit({}).include(DataHelperMixin).inherit(function () {
            ...
            var members = {
                ...
                generateDataValues: function generateDataValues(data, columns) {
                    var values = [],
                        column,
                        value;
                ...
                updateItems: function updateItems(change) {
                    change = change || {};
                    var that = this;
                ...
                */
                ...
                clearFilter: function clearFilter(filterName) {
                    var that = this,
                        columnsController = that._columnsController,
                        clearColumnOption = function clearColumnOption(optionName) {
                ...
                */
                repaintRows: function repaintRows(rowIndexes) {
