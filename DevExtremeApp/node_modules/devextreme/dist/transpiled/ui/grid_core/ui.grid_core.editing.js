...
var EditingController = modules.ViewController.inherit(function () {
    ...
    var editCellTemplate = function editCellTemplate(container, options) {
        var editingTexts,
            editingOptions,
            $container = $(container),
    ...
    return {
        ...
        _handleDataChanged: function _handleDataChanged(args) {
            ...
            if (args.changeType === "refresh" && _getEditMode(that) === EDIT_MODE_POPUP && editForm && editForm.option("visible")) {
                editForm.repaint();
            }
        },
        ...
        refresh: function refresh() {
            if (_getEditMode(this) === EDIT_MODE_CELL) return;
        ...
        _initNewRow: function _initNewRow(options, insertKey) {
        ...
        _showEditPopup: function _showEditPopup(rowIndex) {
            var that = this,
                ...
                toolbarItems: [{ toolbar: 'bottom', location: 'after', widget: 'dxButton', options: that._getSaveButtonConfig() }, { toolbar: 'bottom', location: 'after', widget: 'dxButton', options: that._getCancelButtonConfig() }],
        ...
        editCell: function editCell(rowIndex, columnIndex) {
            ...
            if (column && item && (item.rowType === "data" || item.rowType === "detailAdaptive") && !item.removed && !_isRowEditMode(that)) {
        ...
        _saveEditDataCore: function _saveEditDataCore(deferreds, results) {
            var that = this,
        ...
        saveEditData: function saveEditData() {
            ...
            var resetEditIndices = function resetEditIndices(that) {
        ...
        _createLink: function _createLink(container, text, methodName, options, useIcon) {
            var that = this,
                $link = $("<a>").addClass(LINK_CLASS).addClass(EDIT_LINK_CLASS[methodName]);
        ...
        _createEditingLinks: function _createEditingLinks(container, options, editingOptions, isRowMode) {
            ...
            rowsView: {
                ...
                _isFormItem: function _isFormItem(parameters) {
                    var isDetailRow = parameters.rowType === "detail" || parameters.rowType === "detailAdaptive",
                        isPopupEditing = parameters.rowType === "data" && _getEditMode(this) === "popup";
