    ...
    views: {
        rowsView: columnsView.ColumnsView.inherit(function () {
            ...
            return {
                ...
                _createEmptyRow: function _createEmptyRow() {
                    var that = this,
                        i,
                        $row = that._createRow(),
                ...
                _renderFreeSpaceRow: function _renderFreeSpaceRow(tableElement, options) {
                ...
                getTopVisibleItemIndex: function getTopVisibleItemIndex() {
                    var that = this,
                        itemIndex = 0,
                        prevOffsetTop = 0,
                        offsetTop = 0,
