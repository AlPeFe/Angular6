...
exports.SelectionController = gridCore.Controller.inherit(function () {
    ...
    return {
        ...
        _createSelection: function _createSelection(options) {
        ...
        _fireSelectionChanged: function _fireSelectionChanged(options) {
            ...
            var argument = this.option("selection.deferred") ? { selectionFilter: this.option("selectionFilter") } : { selectedRowKeys: this.option("selectedRowKeys") };
