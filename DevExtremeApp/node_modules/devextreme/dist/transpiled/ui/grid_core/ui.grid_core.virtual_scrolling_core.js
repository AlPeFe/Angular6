...
exports.VirtualScrollController = Class.inherit(function () {
    ...
    var currentPageIsLoaded = function currentPageIsLoaded(that) {
    ...
    return {
        ...
        _setViewportPositionCore: function _setViewportPositionCore(position, isNear) {
            var that = this,
                result = new Deferred(),
        ...
        handleDataChanged: function handleDataChanged(callBase) {
            var that = this,
                beginPageIndex,
                dataSource = that._dataSource,
