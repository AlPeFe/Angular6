    ...
    var createHeaderInfo = function () {
        ...
        var addInfoItem = function addInfoItem(info, options) {
            var itemInfo,
                ...
                addInfoItemCore = function addInfoItemCore(info, infoItem, itemIndex, depthIndex, isHorizontal) {
                ...
                if (!item.children || item.children.length === 0) {
                    ...
                    for (i = 0; i < cellDescriptions.length; i++) {
                        var isGrandTotal = item.type === GRAND_TOTAL_TYPE,
                            ...
                            columnIsHidden = cellDescriptions[i].visible === false || isGrandTotal && inArray(i, options.hiddenGrandTotals) !== -1 || isTotal && inArray(i, options.hiddenTotals) !== -1 || isValue && inArray(i, options.hiddenValues) !== -1;
