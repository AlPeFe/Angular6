...
module.exports = Class.inherit(function () {
    ...
    var updateHeaderItems = function updateHeaderItems(headerItems, newHeaderItems) {
        var d = new Deferred();
    ...
    */
    ...
    return {
        ...
        */
        ...
        getFieldValues: function getFieldValues(index) {
            var that = this,
        ...
        */
        ...
        applyPartialDataSource: function applyPartialDataSource(area, path, dataSource, deferred) {
            var that = this,
                loadedData = that._data,
