...
var typeUtils = require("../../core/utils/type"),
    ...
    ROW = "row",
    NULL = null,
    calculatePercentValue = function calculatePercentValue(value, totalValue) {
    ...
    _percentOfGrandTotal = function _percentOfGrandTotal(e, dimension) {
    return calculatePercentValue(e.value(), e.grandTotal(dimension).value());
},
    percentOfParent = function percentOfParent(e, dimension) {
    var parent = e.parent(dimension),
        parentValue = parent ? parent.value() : e.value();

    return calculatePercentValue(e.value(), parentValue);
},
    createAbsoluteVariationExp = function createAbsoluteVariationExp(allowCrossGroup) {
    return function (e) {
    ...
    createPercentVariationExp = function createPercentVariationExp(allowCrossGroup) {
    ...
    createRunningTotalExpr = function createRunningTotalExpr(field) {
