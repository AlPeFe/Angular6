...
var NumberBoxMask = NumberBoxBase.inherit({
    ...
    _moveCaretToBoundary: function _moveCaretToBoundary(direction, e) {
    ...
    _getEditedText: function _getEditedText(text, selection, char) {
    ...
    _getPrecisionLimits: function _getPrecisionLimits(format, text) {
