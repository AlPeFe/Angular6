...
var Lookup = DropDownList.inherit({
    ...
    _defaultOptionsRules: function _defaultOptionsRules() {
        return this.callBase().concat([{
            ...
            device: function device(_device2) {
                return _device2.platform === "win" && _device2.phone && _device2.version && _device2.version[0] === 8;
            },
            options: {
                /**
                * @name dxLookupOptions.showCancelButton
            ...
            device: function device(_device3) {
                return _device3.platform === "win" && !_device3.phone && _device3.version && _device3.version[0] === 8;
            },
            options: {
                popupWidth: function popupWidth() {
                    return $(window).width();
    ...
    _attachSearchChildProcessor: function _attachSearchChildProcessor() {
    ...
    _renderSearchVisibility: function _renderSearchVisibility() {
        if (this._popup) {
    ...
    _onFocusInHandler: function _onFocusInHandler() {
        this._setListOption("_keyboardProcessor", undefined);
    },
