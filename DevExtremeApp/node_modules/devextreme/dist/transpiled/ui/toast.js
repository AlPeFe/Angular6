    ...
    _defaultOptionsRules: function _defaultOptionsRules() {
        return this.callBase().concat([{
            device: function device(_device) {
                return _device.platform === "win" && _device.version && _device.version[0] === 8;
            },
            options: {
                /**
                * @name dxToastOptions.position
            ...
            device: function device(_device2) {
                return _device2.platform === "win" && _device2.version && _device2.version[0] === 10;
            },
            options: {
                /**
                * @name dxToastOptions.position
            ...
            device: function device(_device3) {
                var isPhone = _device3.deviceType === "phone",
                    isAndroid = _device3.platform === "android",
                    isWin10 = _device3.platform === "win" && _device3.version && _device3.version[0] === 10;
