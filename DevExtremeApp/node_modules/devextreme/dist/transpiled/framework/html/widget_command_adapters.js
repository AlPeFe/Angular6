...
var WidgetItemWrapperBase = Class.inherit({
    ctor: function ctor(command, containerOptions) {
        this.command = command;
        this.widgetItem = this._createWidgetItem(command, containerOptions);
    },
    _createWidgetItem: function _createWidgetItem(command, containerOptions) {
        var itemOptions = extend({}, containerOptions, command.option()),
            executeCommandCallback = function executeCommandCallback(e) {
            command.execute(e);
        },
            result;
...
var WidgetAdapterBase = Class.inherit({
    ...
    _onWidgetItemRendered: function _onWidgetItemRendered(e) {
    ...
    _onWidgetContentReady: function _onWidgetContentReady(e) {
        this.animationDeferred = this._transitionExecutor.start();
    },
    _onWidgetDisposing: function _onWidgetDisposing() {
        this.dispose(true);
    },
    _setWidgetItemOption: function _setWidgetItemOption(optionName, optionValue, itemCommand) {
    ...
    _requireWidgetRefresh: function _requireWidgetRefresh(optionName) {
        return optionName === "visible" || optionName === "locateInMenu" || optionName === "location";
    },
    _onCommandChanged: function _onCommandChanged(args) {
    ...
    _addItemToWidget: function _addItemToWidget(itemWrapper) {
        var items = this.widget.option("items");
    ...
    clear: function clear(widgetDisposing) {
        var that = this;
    ...
    _clearWidgetItems: function _clearWidgetItems() {
        this.widget.option("items", []);
    },
    dispose: function dispose(widgetDisposing) {
...
var CommandToWidgetAdapter = Class.inherit({
    ctor: function ctor(createAdapter) {
        this.createAdapter = createAdapter;
    },
    _getWidgetAdapter: function _getWidgetAdapter($container) {
    ...
    addCommand: function addCommand($container, command, containerOptions) {
    ...
    beginUpdate: function beginUpdate($container) {
        var widgetAdapter = this._getWidgetAdapter($container);
        widgetAdapter.beginUpdate();
    },
    endUpdate: function endUpdate($container) {
        var widgetAdapter = this._getWidgetAdapter($container);
...
var dxNavBarAdapter = WidgetAdapterBase.inherit({
    ...
    _onNavBarItemClick: function _onNavBarItemClick(e) {
        var items = this.widget.option("items");
...
var dxPivotAdapter = WidgetAdapterBase.inherit({
    ...
    _onPivotSelectionChange: function _onPivotSelectionChange(e) {
    ...
    _reRenderPivot: function _reRenderPivot() {
        var that = this;
...
var dxSlideOutAdapter = WidgetAdapterBase.inherit({
    ...
    _onSlideOutItemClick: function _onSlideOutItemClick(e) {
        e.itemData.command.execute(e);
    },
    _getWidgetByElement: function _getWidgetByElement($element) {
