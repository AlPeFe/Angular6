...
var Route = Class.inherit({
    _trimSeparators: function _trimSeparators(str) {
        return str.replace(/^[\/.]+|\/+$/g, "");
    },
    _escapeRe: function _escapeRe(str) {
        return str.replace(/[^-\w]/g, "\\$1");
    },
    _checkConstraint: function _checkConstraint(param, constraint) {
        param = String(param);
    ...
    ctor: function ctor(pattern, defaults, constraints) {
    ...
    format: function format(routeValues) {
        var that = this,
            query = "";
        this._ensureReady();
    ...
    formatSegment: function formatSegment(value) {
    ...
    parseSegment: function parseSegment(value) {
...
var Router = Class.inherit({
    ...
    _createRoute: function _createRoute(pattern, defaults, constraints) {
    ...
    */
    register: function register(pattern, defaults, constraints) {
