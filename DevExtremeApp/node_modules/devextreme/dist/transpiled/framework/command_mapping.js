...
var CommandMapping = Class.inherit({
    ...
    setDefaults: function setDefaults(containerId, defaults) {
        this._containerDefaults[containerId] = defaults;
        return this;
    },
    mapCommands: function mapCommands(containerId, commandMappings) {
        var that = this;
    ...
    unmapCommands: function unmapCommands(containerId, commandIds) {
        var that = this;
    ...
    getCommandMappingForContainer: function getCommandMappingForContainer(commandId, containerId) {
        return (this._commandMappings[containerId] || {})[commandId];
    },
    checkCommandsExist: function checkCommandsExist(commands) {
        var that = this,
    ...
    _initExistingCommands: function _initExistingCommands() {
        var that = this;
